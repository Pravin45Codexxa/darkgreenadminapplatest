...
final Uri getStaticsApi = Uri.parse('${baseUrl}get_statistics');
final Uri getSettingApi = Uri.parse('${baseUrl}get_settings');
final Uri getOrdersApi = Uri.parse('${baseUrl}get_orders');
final Uri getResetPassApi = Uri.parse('${baseUrl}forgot_password');
...
final Uri updateOrderTrackingmApi = Uri.parse('${baseUrl}get_order_tracking');
...
final Uri getCustApi = Uri.parse('${baseUrl}get_customers');
final Uri getDelBoyApi = Uri.parse('${baseUrl}get_delivery_boys');
final Uri getReturnRequestApi = Uri.parse('${baseUrl}get_return_requests');
final Uri getUpdateReturnRequestApi =
    Uri.parse('${baseUrl}update_return_request');
...
final Uri changeBankTransferStatusApi =
    Uri.parse('${baseUrl}update_receipt_status');
final Uri editOrderTrackingApi = Uri.parse('${baseUrl}edit_order_tracking');
final Uri manageDeliveryBoyCashCollectionApi =
    Uri.parse('${baseUrl}manage_delivery_boy_cash_collection');
final Uri getDeliveryBoyCashCollectionApi =
...
final Uri addProductsApi = Uri.parse('${baseUrl}add_product');
...
final Uri addBrandApi = Uri.parse('${baseUrl}add_brand');
final Uri getBrandApi = Uri.parse('${baseUrl}get_brands_data');
final Uri deleteBrandApi = Uri.parse('${baseUrl}delete_brand');
final Uri sendDigitalProductMailApi =
    Uri.parse("${baseUrl}send_digital_product_mail");
final Uri getDigitalOrderMailApi =
    Uri.parse('${baseUrl}get_digital_order_mails');
...
const String CASH_TO_COLLECT = 'cash_received';
...
const String FILE_URL = 'file_url';
...
const String CASH_COLLECTED_BY_ADMIN = 'Cash collected by admin';
const String CASH_RECEIVED_BY_DEL_BOY = 'Cash Received by Deliveryboy';

const String IMGS = 'images[]';
const String NAME = 'name';
const String SHOW_NAME = 'Name';
const String SHOW_EMAIL = 'Email';
const String SHOW_CONTACT = 'Contact No.';
const String SHOW_ADD = 'Address';
const String SHOW_BALANCE = 'Balance';
const String SHOW_CASH_TO_COLLECT = 'Cash to Collect';
const String SHOW_COLLECT_CASH = 'Collect Cash';
const String SHOW_TRANSACTION = 'Old Transactions';
...
const String IS_LOCAL_PICKUP = 'is_local_pickup';
...
const String RETURN_REQ_ID = 'return_request_id';
const String UPDATE_REMARKS = 'update_remarks';
...
const String READYTOPICKUP = 'ready_to_pickup';
...
const String MAIL_SENT = 'Mail Sent';
...
const String DOWNLOAD_ALLOW = 'download_allowed';
const String IS_SENT = 'is_sent';
