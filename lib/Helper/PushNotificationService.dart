...
/*    const MacOSInitializationSettings initializationSettingsMacOS =
  ...
  Future<void> getStatics(String type, String id) async {
    ...
    Response response = await post(getStaticsApi, body: parameter, headers: headers)
  ...
  void _registerToken(String? token) async {
    ...
    Response response = await post(updateFcmApi, body: parameter, headers: headers).timeout(
